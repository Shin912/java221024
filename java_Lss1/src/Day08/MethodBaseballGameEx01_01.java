...
public class MethodBaseballGameEx01_01 {
	...
	/** 
	 * 기능 : strike와 ball의 갯수가 주어지면 콘솔에 결과를 출력하는 메소드
	...
	/** 
	 * 기능 : 두 정수 배열이 주어지면 같은 숫자들 중에서 번지가 서로 다른 숫자들의 갯수를
	 * 		알려주는 메소드
	 * @param arr1 int[] : 첫번째 정수 배열
	 * @param arr2 int[] : 두번째 정수 배열 
	 * @return  같은 숫자들 중에서 번지가 서로 다른 숫자들의 갯수
	 * */
