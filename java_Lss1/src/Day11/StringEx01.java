...
public class StringEx01 {
	...
	public static void main(String[] args) {
		 ...
		 *  lastIndexOf(문자 또는 문자열 : 해당 문자열/문자를 마지막 번지부터
		 *  	탐색하여 첫번째로 만나는 문자열/문자의 시작번지 
		 ...
		 * subString(시작번지, 마지막번지) : 문자열의 시작번지부터 마지막 번지 -1까지
		 * 				부분문자열을 추출
		 * */
		 ...
		 * */
		String str4 = "Hello";
		System.out.println(str4 + " 문자열에 2번지에 있는 문자 : " + str4.charAt(4));
		
		/* split(전규표현식) : 정규표현식을 기준으로 문자열을 추출하여 배열로 만듬
		 * */
