...
public class EqualsEx01 {
	...
	public static void main(String[] args) {
		...
		Test t = new Test(2,1);
		System.out.println(t.equals(new Test(2,2)));
		
		/* list.indexOf(비교객체)에서 Objects.equals를 호출하는데,
		 * Objexts.equals(비교객체, 리스트에서 꺼낸 객체)를 호출하기 때문에
		 * 비교객체.equals(리스트에서 꺼낸 객체)로 비교
		 * 아래 indexOf는 Integer.equals(Tesr 객체)를 하기 때문에 -1이 나옴
		 * */
		index = list.indexOf((Integer)2);
		System.out.println(index);
		System.out.println(t.equals((Integer)2));
		//Objexts.equals(a,b) : a.equals(b)를 호출
